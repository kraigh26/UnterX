  ...
  describe "#needs_redirect" do
    ...
    it "redirects to full domain, if marketplace is accessed with the subdomain (ident) and full domain is provided and use_domain is true" do
      expect_redirect(community: {
                        ...
                        deleted: false,
                        domain: "www.marketplace.com",
                      }).to eq(reason: :domain, url: "www.marketplace.com/listings", status: :moved_permanently)
    end
    ...
    it "includes port" do
      expect_redirect(request: {
                      ...
                      community: {
                        ...
                        deleted: false,
                        use_domain: true,
                      }).to eq(reason: :domain, url: "www.marketplace.com:3333/listings", status: :moved_permanently)
    end
    ...
    it "adds utm_ parameters when redirecting deleted" do
      expect_redirect(community: {
                      ...
                      paths: {
                        community_not_found: {url: "redirect.site.com"},
                      }).to eq(reason: :deleted,
                               url: "redirect.site.com?utm_source=www.marketplace.com&utm_medium=redirect&utm_campaign=dl-auto-redirect",
      ...
      expect_redirect(community: {
                      ...
                      paths: {
                        community_not_found: {url: "redirect.site.com"},
                               ...
                               url: "redirect.site.com?utm_source=www.marketplace.com&utm_medium=redirect&utm_campaign=qc-auto-redirect",
                               status: :moved_permanently)
    end
    ...
    it "adds utm_ parameters when redirecting no community found and other communties exist" do
      expect_redirect(community: nil,
                      ...
                      paths: { community_not_found: { url: "redirect.site.com"} }
                     ).to eq(reason: :not_found,
                             url: "redirect.site.com?utm_source=www.wrongmarketplace.com&utm_medium=redirect&utm_campaign=na-auto-redirect",
                             status: :found)
    end
    ...
    it "redirects to marketplace ident without www" do
      expect_redirect(request: {
                     ...
                     ).to eq(reason: :www_ident, url: "marketplace.sharetribe.com/listings", status: :moved_permanently)
    end
    ...
    it "redirects back to ident if domain is not in use" do
      expect_redirect(request: {
                     ...
                     ).to eq(reason: :no_domain, url: "marketplace.sharetribe.com/listings", status: :moved_permanently)
    end
  end
end
